...
<?php $__env->startSection('title'); ?>Tambah Tata Cara
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form theme-form" action="<?php echo e(route('tatacara.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
							<div class="row">
								<div class="col">
...
unset($__errorArgs, $__bag); ?>" name="nama" value="<?php echo e(old('nama')); ?>" required autocomplete="nama" autofocusid="exampleFormControlInput1" type="text"/>
...
unset($__errorArgs, $__bag); ?>" name="file" id="exampleFormControlInput1"  type="file"  />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\swi\resources\views/admin/tatacara/create.blade.php ENDPATH**/ ?>