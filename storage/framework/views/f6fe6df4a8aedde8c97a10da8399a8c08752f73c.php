		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form theme-form" action="<?php echo e(route('vendor.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
							<div class="row">
								<div class="col">
...
unset($__errorArgs, $__bag); ?>" name="nama_supplier" value="<?php echo e(old('nama_supplier')); ?>" required autocomplete="nama_supplier" autofocusid="exampleFormControlInput1" type="text"/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abdibusana\resources\views/admin/vendor/create.blade.php ENDPATH**/ ?>