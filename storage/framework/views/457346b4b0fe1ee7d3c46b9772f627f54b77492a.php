	        ...
	        <div class="col-sm-12">
	            <div class="card">
	                <div class="card-header">
	                    <span>
							<a href="<?php echo e(route('bpjstk.createprogram')); ?>"><button type="button" class="btn btn-warning">+ Tambah</button></a>
							<br>
							<br>
	                    ...
	                    <div class="dt-ext table-responsive">
	                        <table class="display" id="responsive">
                                ...
                                <tr>
                                    ...
                                    <td> 
                                       <form action="<?php echo e(route('bpjstk.destroyprogram', $u->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?> 
                                        <?php echo method_field('get'); ?>
                                        <a href="<?php echo e(route('bpjstk.editprogram', $u->id)); ?>" class="btn btn-success btn-sm">Edit</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abdibusana\resources\views/admin/BPJS_TK/jenis.blade.php ENDPATH**/ ?>