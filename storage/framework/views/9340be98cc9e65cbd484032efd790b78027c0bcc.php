								...
								<div class="col">
									<div class="mb-3">
										...
										<select class="form-select digits" name="jenis" id="exampleFormControlSelect9">
											...
											<option value="JHTP">Jaminan Hari Tua (JHT) yang dibayar oleh perusahaan</option>
											<option value="JHTK">Jaminan Hari Tua (JHT) yang dibayar oleh karyawan</option>
                                            <option value="JKM">Jaminan Kematian</option>
											<option value="JP">Jaminan Pensiun</option>
										</select>
									</div>
								</div>
							</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\swi\resources\views/admin/BPJS_TK/create_program.blade.php ENDPATH**/ ?>