...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo e(asset('assets/images/logo/icon_ab.png')); ?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/logo/icon_ab.png')); ?>" type="image/x-icon">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 footer-copyright">
                <p class="mb-0">Copyright <?php echo e(date('Y')); ?>-<?php echo e(date('y', strtotime('+1 year'))); ?> © PT.Saputra Wisesa Indonesia.</p>
              </div>
              <div class="col-md-6">
                <p class="pull-right mb-0">Support by :  <a href="www.ittech-solution.com">IT Tech Solution</a></p>
              </div>
            </div>
          </div>
        </footer>
...
</html><?php /**PATH C:\xampp\htdocs\abdibusana\resources\views/layouts/admin/master.blade.php ENDPATH**/ ?>