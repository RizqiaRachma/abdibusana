		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form theme-form" action="{{route('konsumen.store')}}" method="POST">
                        @csrf
                        <div class="card-body">
							<div class="row">
								<div class="col">
									<div class="mb-3">
										...
										<input class="form-control @error('nama_konsumen') is-invalid @enderror" name="nama_konsumen" value="{{ old('nama_konsumen') }}" required autocomplete="nama_konsumen" autofocusid="exampleFormControlInput1" type="text"/>
                                        @error('nama_konsumen')
